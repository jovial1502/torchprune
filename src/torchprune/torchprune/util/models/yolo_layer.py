    ...
    def build_targets(self, pred_boxes, target, anchors, nH, nW):
        ...
        for b in range(nB):
            ...
            for t in range(tbox.size(0)):
                ...
                cur_ious = torch.max(cur_ious, self.multi_bbox_ious(cur_pred_boxes, cur_gt_boxes, x1y1x2y2=False))
            ...
            for t in range(tbox.size(0)):
                ...
                _, best_n = torch.max(self.multi_bbox_ious(tmp_gt_boxes, anchor_boxes, x1y1x2y2=False), 0)
