...
class Darknet(nn.Module):
    ...
    def __init__(self, config_path="E:\\Studium\\THESIS\\Codebase\\torchprune\\src\\experiment\\experiment\\param\\yolov3-tiny.cfg"):
...
def yolov3tiny2(num_classes):
    """Return a fully-initialized CNN60K."""
    return Darknet(num_classes)           